...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.astera.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.astera.device")
  script.PrintAsteraBanner(android_version, build_id, build_date,
